    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property_type', models.CharField(choices=[('Residential units', 'Residential Units'), ('Commercial', 'Commercial'), ('Rooms', 'Rooms'), ('Others', 'Others')], max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permit_number', models.CharField(blank=True, max_length=32, null=True)),
                ('agent_name', models.CharField(blank=True, max_length=32, null=True)),
                ('property_type', models.CharField(choices=[('Residential', 'Residential'), ('Commercial', 'Commercial'), ('Land', 'Land'), ('Others', 'Others')], max_length=32)),
                ('property_reference_id', models.CharField(blank=True, max_length=32, null=True)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('usage', models.CharField(blank=True, max_length=64, null=True)),
                ('purpose', models.CharField(choices=[('sale', 'For Sale'), ('rent', 'For Rent')], max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('education_level', models.CharField(blank=True, max_length=64, null=True)),
                ('salary_range', models.CharField(blank=True, max_length=64, null=True)),
                ('cv', models.FileField(blank=True, null=True, upload_to='advertise/jobs/cv/')),
